...
|---|---|---|---|
| **BDTG (Leader)** | 132 | ~69.8% | 🟢 Vượt chỉ tiêu |
| **newiexk-cyber** | 22 | ~11.6% | 🔴 Cần cố gắng hơn |
| **Simpson-31ev3n** | 18 | ~9.5% | 🔴 Cần cố gắng hơn |
| **khanhphamvn222** | 17 | ~9.0% | 🔴 Cần cố gắng hơn |

*(Tổng số commits dự án: 189)*
<!-- END_STATS -->
