...
|---|---|---|---|
| **BDTG (Leader)** | 136 | ~70.5% | 🟢 Vượt chỉ tiêu |
| **newiexk-cyber** | 22 | ~11.4% | 🔴 Cần cố gắng hơn |
| **Simpson-31ev3n** | 18 | ~9.3% | 🔴 Cần cố gắng hơn |
| **khanhphamvn222** | 17 | ~8.8% | 🔴 Cần cố gắng hơn |

*(Tổng số commits dự án: 193)*
<!-- END_STATS -->
