...
|---|---|---|---|
| **BDTG (Leader)** | 130 | ~72.2% | 🟢 Vượt chỉ tiêu |
| **Simpson-31ev3n** | 18 | ~10.0% | 🔴 Cần cố gắng hơn |
| **khanhphamvn222** | 17 | ~9.4% | 🔴 Cần cố gắng hơn |
| **newiexk-cyber** | 15 | ~8.3% | 🔴 Cần cố gắng hơn |

*(Tổng số commits dự án: 180)*
<!-- END_STATS -->
