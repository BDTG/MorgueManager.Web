...
|---|---|---|---|
| **newiexk-cyber** | 226 | ~79.3% | 🟢 Tốt |
| **BDTG (Leader)** | 44 | ~15.4% | 🟢 Vượt chỉ tiêu |
| **Simpson-31ev3n** | 9 | ~3.2% | 🔴 Cần cố gắng hơn |
| **khanhphamvn222** | 6 | ~2.1% | 🔴 Cần cố gắng hơn |

*(Tổng số commits dự án: 285)*
<!-- END_STATS -->
