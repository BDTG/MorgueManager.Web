...
|---|---|---|---|
| **BDTG (Leader)** | 155 | ~68.3% | 🟢 Vượt chỉ tiêu |
| **newiexk-cyber** | 33 | ~14.5% | 🔴 Cần cố gắng hơn |
| **Simpson-31ev3n** | 20 | ~8.8% | 🔴 Cần cố gắng hơn |
| **khanhphamvn222** | 19 | ~8.4% | 🔴 Cần cố gắng hơn |

*(Tổng số commits dự án: 227)*
<!-- END_STATS -->
