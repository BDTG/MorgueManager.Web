...
|---|---|---|---|
| **BDTG (Leader)** | 165 | ~67.3% | 🟢 Vượt chỉ tiêu |
| **newiexk-cyber** | 33 | ~13.5% | 🔴 Cần cố gắng hơn |
| **Simpson-31ev3n** | 24 | ~9.8% | 🔴 Cần cố gắng hơn |
| **khanhphamvn222** | 23 | ~9.4% | 🔴 Cần cố gắng hơn |

*(Tổng số commits dự án: 245)*
<!-- END_STATS -->
